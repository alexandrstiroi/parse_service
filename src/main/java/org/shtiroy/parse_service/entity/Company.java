...
@Entity
@Table(schema = "working_data", name = "t_company")
public class Company {
    ...
    public Company(String idno, Date dateStart, String companyName, String companyType, String companyAddress, String cuatm, String companyLeaders, String companyFounders, String companyBeneficiaries, String companyActivities, String companyActivitiesLic, Date dateEnd) {
        this.idno = idno;
